...
// Examples for manipulating class parcelle_class
require_once(DOL_DOCUMENT_ROOT."/../vignoble/parcelle.class.php");
$myobject=new Parcelle($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."parcelle";
